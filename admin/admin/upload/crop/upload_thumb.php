...
$thumb_height = "750";						// Height of thumbnail image
...
}elseif($category=="choir"){
$thumb_width = "545";						// Width of thumbnail image
$thumb_height = "361";						// Height of thumbnail image
}else
...
if (isset($_POST["upload_thumbnail"]) && strlen($large_photo_exists)>0) {
	...
	//mysql_query("update last_edited set photo_name='$new_image' where category='$category'")or die(mysql_error());
	 mysql_query("update photo set update_time='$time',thumb_nail='$new_image' where photo_id='$nextid' && category ='$category'")or die(mysql_error());
